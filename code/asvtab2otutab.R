...
# Define arguments
option_list = list(
  make_option(c("-i", "--path_to_table"), type = "character", default = NULL, help = "Path to the ASV table",
            metavar = "character"),
  make_option(c("-f", "--out_path_fasta"), type = "character", default = "asvs.fasta", help = "Path to the FASTA output file",
            metavar = "character"),
  make_option(c("-a", "--out_path_asv"), type = "character", default = "asvtab.tsv", help = "Path to the ASV output file",
            metavar = "character"),
  make_option(c("-o", "--out_path_otu"), type = "character", default = "otutab.tsv", help = "Path to the OTU output file",
            metavar = "character"),
  make_option(c("-u", "--out_path_uparse"), type = "character", default = "uparse.tsv", help = "Path to the uprase file",
            metavar = "character"),
...
cmmd <- system(command = paste("usearch -cluster_otus ", out_path_fasta, " -minsize 1 -otus ", out_path_otu_fasta,
                                    " -uparseout ", out_path_uparse, " -relabel otu", sep = ""))
cat("DONE\n")
