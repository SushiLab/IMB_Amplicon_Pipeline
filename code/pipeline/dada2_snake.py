...
rule r1r2_sample_files:
    ...
    shell:
        '''
        python {SCRIPTFOLDER}create_samples_files.py {params.project_folder} {output.r1_samples} {output.r2_samples} {params.samples_2_use}
        '''
...
rule dada2_learnErrors:
    ...
    shell:
        '''
        command="
        Rscript {SCRIPTFOLDER}dada2_learnErrors.R {input.samples} {output.rds} {threads} {params.nbases} &> {log.log}
        ";
        echo "$command" > {log.command};
        eval "$command"
        '''
